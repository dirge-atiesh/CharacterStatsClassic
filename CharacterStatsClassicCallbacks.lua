...
function CSC_CharacterSpellDamageFrame_OnEnter(self)
	...
	self.arcaneDmg = GetSpellBonusDamage(7);
        self.undeadDmg = CSC_GetBonusUndeadSpellDamage("player") + max(self.holyDmg, self.fireDmg, self.natureDmg, self.frostDmg, self.shadowDmg, self.arcaneDmg);
	...
	GameTooltip:AddDoubleLine(SPELL_SCHOOL3_CAP.." "..DAMAGE..": ", format("%.2F", self.natureDmg), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
        GameTooltip:AddDoubleLine("Undead "..DAMAGE..": ", format("%.2F", self.undeadDmg), NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b);
	GameTooltip:Show();
end
